"""Retired unguarded API, retained for source audit and synthetic regressions only."""
raise RuntimeError("Legacy API is retired; use the closed app.main entry point")
